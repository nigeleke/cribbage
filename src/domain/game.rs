    ...
    pub fn discard(mut self, player: Player, discards: &[Card]) -> Result<DiscardResult> {
        ...
        let result = match discard_state {
            DiscardingState::StillDiscarding => {
                ...
                DiscardResult::Discarding(Box::new(Game::<_>::new(discarding_state)))
            }
...
impl Game<Playing> {
    pub fn play(self, player: Player, card: Card) -> Result<PlayResult> {
        ...
        let result = if let Some(winner) = scores.winner() {
            ...
            let playing_state = Playing::new(scores, roles, hands, play_state, cut, crib);
            PlayResult::Playing(Box::new(Game::<_>::new(playing_state)))
        };
    ...
    pub fn pass(self, player: Player) -> Result<PassResult> {
        ...
        let result = if let Some(winner) = scores.winner() {
            ...
            let playing_state = Playing::new(scores, roles, hands, play_state, cut, crib);
            PassResult::Playing(Box::new(Game::<_>::new(playing_state)))
        };
...
mod test {
    ...
    mod the_play {
        ...
        fn accept_valid_play() {
            ...
            let PlayResult::Playing(game1) =
                game0.play(pone0, Card::from("4S")).expect("valid play")
            else {
                panic!("unexpected state")
            };
        ...
        fn score_play_when_target_not_reached_mid_play() {
            ...
            let PlayResult::Playing(game1) =
                game0.play(pone0, Card::from("5H")).expect("valid play")
            else {
                panic!("unexpected state")
            };
        ...
        fn score_play_when_target_not_reached_end_play() {
            ...
            let PlayResult::Playing(game1) =
                game0.play(pone0, Card::from("2H")).expect("valid play")
            else {
                panic!("unexpected state")
            };
        ...
        fn score_play_when_target_reached_finished() {
            ...
            let PlayResult::Finished(game1) =
                game0.play(pone0, Card::from("AH")).expect("valid play")
            else {
                panic!("unexpected state")
            };
        ...
        fn swap_player_after_dealer_play() {
            ...
            let PlayResult::Playing(game1) =
                game0.play(dealer0, Card::from("9C")).expect("valid play")
            else {
                panic!("unexpected state")
            };
        ...
        fn reset_play_after_exact_target_reached() {
            ...
            let PlayResult::Playing(game1) =
                game0.play(dealer0, Card::from("8H")).expect("valid play")
            else {
                panic!("unexpected state")
            };
        ...
        fn score_play_points_for_fifteens() {
            ...
            let PlayResult::Playing(game1) =
                game0.play(pone0, Card::from("8D")).expect("valid play")
            else {
                panic!("unexpected state")
            };
        ...
        fn score_play_points_for_quartet() {
            ...
            let PlayResult::Playing(game1) =
                game0.play(pone0, Card::from("7D")).expect("valid play")
            else {
                panic!("unexpected state")
            };
        ...
        fn score_play_points_for_run() {
            ...
            let PlayResult::Playing(game1) =
                game0.play(pone0, Card::from("AS")).expect("valid play")
            else {
                panic!("unexpected state")
            };
        ...
        fn score_play_points_for_run_edge_case_1() {
            ...
            let PlayResult::Playing(game1) =
                game0.play(pone0, Card::from("8S")).expect("valid play")
            else {
                panic!("unexpected state")
            };

            let PlayResult::Playing(game1) =
                game1.play(dealer0, Card::from("7H")).expect("valid play")
            else {
                panic!("unexpected state")
            };

            let PlayResult::Playing(game1) =
                game1.play(pone0, Card::from("7S")).expect("valid play")
            else {
                panic!("unexpected state")
            };

            let PlayResult::Playing(game1) =
                game1.play(dealer0, Card::from("6H")).expect("valid play")
            else {
                panic!("unexpected state")
            };
        ...
        fn score_play_points_for_run_edge_case_2() {
            ...
            let PlayResult::Playing(game1) =
                game0.play(pone0, Card::from("9S")).expect("valid play")
            else {
                panic!("unexpected state")
            };
            ...
            let PlayResult::Playing(game1) =
                game1.play(pone0, Card::from("8S")).expect("valid play")
            else {
                panic!("unexpected state")
            };
    ...
    mod pegging {
        ...
        fn should_score_rules_example_flush() {
            ...
            let PlayResult::Playing(game1) =
                game0.play(dealer0, Card::from("AH")).expect("valid play")
            else {
                panic!("unexpected state")
            };
    ...
    mod counting_the_hands {
        ...
        fn score_pone_hand_when_plays_finished() {
            ...
            let PlayResult::Scoring(game1) =
                game0.play(pone0, Card::from("TH")).expect("valid play")
            else {
                panic!("Unexpected state")
            };
