...
pub fn valid_card(s: &str) -> Card {
    Card::try_from(s).expect("valid card")
}

pub fn valid_deck(s: &str) -> Deck {
    Deck::try_from(s).expect("valid deck")
}

pub fn valid_hand(s: &str) -> Hand {
    Hand::try_from(s).expect("valid hand")
}

pub fn valid_crib(s: &str) -> Crib {
