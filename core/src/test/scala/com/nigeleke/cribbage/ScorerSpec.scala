...
import com.nigeleke.cribbage.domain.Card.Suit.*
import com.nigeleke.cribbage.domain.CardsPoints
import com.nigeleke.cribbage.domain.EndPlayPoints
import com.nigeleke.cribbage.domain.Player
import com.nigeleke.cribbage.domain.PlayPoints
import com.nigeleke.cribbage.domain.Plays
import com.nigeleke.cribbage.domain.Points
import util.*
...
class ScorerSpec extends AnyWordSpec with Matchers {
  ...
  "ScoreEndOfPlay" should {
    ...
    val passes = Seq.fill(2)(Plays.Pass(player))
